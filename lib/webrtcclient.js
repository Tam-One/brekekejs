...
(function (WebrtcClient) {
  var WEBRTC_CLIENT_VERSION = '2.0.26.310',
    Phone,
    Logger,
    jssipHack,
    jssipRtcSessionHack,
  ...
  Phone.prototype = {
    ...
    startWebRTC: function (configuration) {
      ...
      password = string(
        configuration.password || defaultConfiguration.password,
      );
     ...
     */
    setWithVideo: function (sessionId, withVideo, videoOptions, exInfo, endVideoCall = false) {
      ...
      session.endVideoCall = endVideoCall
      if (endVideoCall) {
    ...
    getSession: function (sessionId) {
            ...
            for (videoClientSessionId in this._ridVideoClientSessionsTable[
              ...
              if (
                ...
                videoClientSessionTable[videoClientSessionId] = {
                  ...
                  localStreamObject: localVideoStreamObject,
                };
              }
            }
          }
      ...
      return {
        ...
        remoteVideoStreamObject: remoteVideoStreamObject,
        ...
        analyser: analyser,
        endVideoCall: session.endVideoCall
      };
    },
